...
tar cp /home/rasmuserik/data/backup/borg/containers/*/*.log | xz -9 > /home/rasmuserik/data/backup/borg-logs.`date +%F`.tar.xz
tar cp /home/rasmuserik/data/backup/borg | xz -9 > /home/rasmuserik/data/backup/borg.latest.tar.xz
