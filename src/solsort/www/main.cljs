...
(def apps
 ...
 ;  (git 2016  9 "solsort/FMTools")
   ...
   (git 2016  7 "solsort/Tinkuy-Member-Check")
...
;   (wordpress 2015  6 "rasmuserik.com")
   ...
   (git 2014  3 "solsort/Single-touch-snake")
   (git 2014  2 "solsort/KBH-Parking")
   (git 2014  2 "solsort/360-viewer")
